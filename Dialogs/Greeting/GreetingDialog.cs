...
namespace Microsoft.BotBuilderSamples
{
    ...
    public class GreetingDialog : ComponentDialog
    {
        ...
        private const string BookPrompt = "cityPrompt";
            ...
            : base(nameof(GreetingDialog))
        {
            ...
            AddDialog(new TextPrompt(BookPrompt, ValidateCity));
        }
                                                        ...
                                                        CancellationToken cancellationToken)
        {
            ...
            if (string.IsNullOrWhiteSpace(greetingState.City))
            {
                var opts = new PromptOptions
                {
                    ...
                    {
                        Type = ActivityTypes.Message,
                        Text = $"Hello {greetingState.Name}, which book would you like to select?",
                    },
                };
                return await stepContext.PromptAsync(BookPrompt, opts);
            }
            else
            {
                return await stepContext.NextAsync();
                                                    ...
                                                    CancellationToken cancellationToken)
        {
                ...
                !string.IsNullOrWhiteSpace(lowerCaseCity))
            {
                ...
                FileShare.fileName = greetingState.City;
                await UserProfileAccessor.SetAsync(stepContext.Context, greetingState);
            }
        ...
        private async Task<DialogTurnResult> GreetUser(WaterfallStepContext stepContext)
        {
            ...
            var book = greetingState.City.Remove(greetingState.City.LastIndexOf("."));
            // Display their profile information and end dialog.
            await context.SendActivityAsync($"Hi, your book has been set to {book}.");
